 ...
 * 파일에서 템플릿 설치 요청
 */
class InstallTemplateFromFileRequest extends FormRequest
{
    /**
    ...
    {
        $maxSize = config('template.upload_max_size', 50) * 1024; // MB를 KB로 변환
        ...
        return HookManager::applyFilters('core.template.install_from_file_validation_rules', $rules, $this);
    }
