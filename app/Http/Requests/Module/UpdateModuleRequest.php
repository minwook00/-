 ...
 * 모듈 업데이트 요청 검증
 *
 * 모듈의 name, description, status를 업데이트할 수 있습니다.
...
class UpdateModuleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return HookManager::applyFilters('core.module.update_validation_rules', $rules, $this);
    }
    ...
    {
        return [
            'status.in' => __('validation.module.status.in'),
        ];
    }
}
