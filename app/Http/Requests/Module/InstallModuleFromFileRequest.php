 ...
 * 파일에서 모듈 설치 요청
 */
class InstallModuleFromFileRequest extends FormRequest
{
    /**
    ...
    {
        $maxSize = config('module.upload_max_size', 50) * 1024; // MB를 KB로 변환
        ...
        return HookManager::applyFilters('core.module.install_from_file_validation_rules', $rules, $this);
    }
