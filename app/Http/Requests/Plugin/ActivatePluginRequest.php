 ...
 * 플러그인 활성화 요청 검증
 *
 * 플러그인 활성화 시 필요한 데이터를 검증합니다.
 */
class ActivatePluginRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return HookManager::applyFilters('core.plugin.activate_validation_rules', $rules, $this);
    }
