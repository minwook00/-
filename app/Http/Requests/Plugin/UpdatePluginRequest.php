 ...
 * 플러그인 업데이트 요청 검증
 *
 * 플러그인의 name, description, status를 업데이트할 수 있습니다.
...
class UpdatePluginRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return HookManager::applyFilters('core.plugin.update_validation_rules', $rules, $this);
    }
    ...
    {
        return [
            'status.in' => __('validation.plugin.status.in'),
        ];
    }
}
